...
const Navbar = () => {
  ...
  return (
    <div className='nav align-middle z-10'>
      ...
      <ul className={`${dropdown ? `h-0` : `h-full bg-slate-800 top-28`} lg:h-auto flex lg:flex-row flex-col my-auto align-middle overflow-y-hidden transition-all ease-in duration-1000 gap-12 ml-auto mr-auto lg:relative absolute w-full inset-0 items-center`}>
        <li>
        ...
        <li>
          <span className='transition-all duration-300 group flex flex-col items-center'> 
          ...
          <ul className='group-hover:h-fit flex flex-col top-28 bg-slate-600 lg:absolute gap-4 h-0 overflow-y-hidden group-hover:py-3  transition-all ease-in duration-1000 '>
            <li>
