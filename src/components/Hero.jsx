   ...
   return(
     <div className='flex flex-col bg-[#252F46] w-full justify-between lg:flex-row items-center'>
       <div className=' text-white   px-20 pt-20  pb-10 hero-content'>
         <h2 className='text-5xl font-bold leading-normal heading-animate'>Study <br/> Abroad <br/> Simplified!</h2>
         <p className='py-6 leading-normal text-animate'>There is a world out there full of possibilities.<br/>
