 ...
 const Hero =() =>{
   return(
     <div className="flex flex-col  w-full justify-between lg:flex-row items-center bg-[url('./img/pic2.jpeg')] bg-[#252F46]/75  bg-no-repeat bg-blend-soft-light bg-cover bg-center h-screen">
       <div className=' text-white  p-20  pb-10 hero-content w-full'>
         <h2 className='text-5xl font-bold w-full'>Study Abroad Simplified!</h2>
         <p className='py-6 text-lg font-medium w-full'>There is a world out there full of possibilities.
         Our mission is to help you accomplish your dreams.</p>
         <Link to='/'>
          <button className='flex text-lg font-semibold rounded-full bg-[#C2956D] p-4 gap-2 px-6'>
           Learn more <span className="align-middle my-auto w-6 h-6"><svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
