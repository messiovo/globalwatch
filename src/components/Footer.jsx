...
import {AiOutlineTwitter, AiOutlineCopyrightCircle, AiFillInstagram} from 'react-icons/ai'
...
const Footer = () => {
  ...
  return (
    <div className='bg-[#252F46] text-white flex flex-col items-center p-6'>
        ...
        <div className='flex pt-4 gap-6 mx-auto w-fit'>
        {
        // try using svg's instaed of these components
        }
            <Link to='./'><span classsNAme="w-fit"><svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
